...
config :vdlarr, Oban, testing: :manual
...
config :vdlarr, Vdlarr.Repo,
  database: Path.expand("../priv/repo/vdlarr_test.db", Path.dirname(__ENV__.file)),
...
config :vdlarr, Vdlarr.Mailer, adapter: Swoosh.Adapters.Test
