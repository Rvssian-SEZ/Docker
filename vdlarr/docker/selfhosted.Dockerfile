...
RUN apt-get update -y && \
    ...
    # FFmpeg - upstream pinned a specific dated autobuild release (see #347 for why
    # it's not just "latest"), but yt-dlp/FFmpeg-Builds has since pruned that release
    # (404s as of this fork), so we track their rolling "latest" tag instead.
