defmodule Vdlarr.Lifecycle.Notifications.CommandRunnerTest do
  use Vdlarr.DataCase

  alias Vdlarr.Lifecycle.Notifications.CommandRunner, as: Runner

  @original_executable Application.compile_env(:vdlarr, :apprise_executable)
  ...
  defp wrap_executable(new_executable, fun) do
    Application.put_env(:vdlarr, :apprise_executable, new_executable)
    fun.()
    reset_executable()
  end

  def reset_executable do
    Application.put_env(:vdlarr, :apprise_executable, @original_executable)
  end
end
