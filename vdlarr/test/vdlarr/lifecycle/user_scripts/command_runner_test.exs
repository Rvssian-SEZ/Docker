defmodule Vdlarr.Lifecycle.UserScripts.CommandRunnerTest do
  use Vdlarr.DataCase

  alias Vdlarr.Utils.FilesystemUtils
  alias Vdlarr.Lifecycle.UserScripts.CommandRunner, as: Runner
  ...
  describe "run/2" do
    test "runs the provided lifecycle file if present" do
      ...
      tmp_dir = Application.get_env(:vdlarr, :tmpfile_directory)
