defmodule Vdlarr.YtDlp.MediaTest do
  use Vdlarr.DataCase
  ...
  describe "download/3" do
    ...
    test "parses and returns the generated file as JSON" do
      ...
      assert {:ok, %{"title" => "Vdlarr Example Video"}} =
  ...
  describe "indexing_output_template/0" do
    test "contains all the greatest hits" do
      attrs =
        ~w(id title live_status original_url description aspect_ratio duration upload_date timestamp playlist_index filename extractor)a
