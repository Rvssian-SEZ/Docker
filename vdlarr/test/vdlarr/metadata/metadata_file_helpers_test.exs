defmodule Vdlarr.Metadata.MetadataFileHelpersTest do
  use Vdlarr.DataCase

  import Vdlarr.MediaFixtures
  import Vdlarr.SourcesFixtures

  alias Vdlarr.Metadata.MetadataFileHelpers, as: Helpers
  ...
  describe "metadata_directory_for/1" do
    test "returns the metadata directory for the given record", %{media_item: media_item} do
      base_metadata_directory = Application.get_env(:vdlarr, :metadata_directory)
