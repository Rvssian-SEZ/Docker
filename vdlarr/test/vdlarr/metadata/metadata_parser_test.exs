defmodule Vdlarr.Metadata.MetadataParserTest do
  use Vdlarr.DataCase
  import Vdlarr.MediaFixtures

  alias Vdlarr.Metadata.MetadataParser, as: Parser
  ...
  describe "parse_for_media_item/1 when testing media metadata" do
    test "it extracts the media filepath", %{metadata: metadata} do
      ...
      assert String.contains?(result.media_filepath, "Vdlarr Example Video-ABC123")
