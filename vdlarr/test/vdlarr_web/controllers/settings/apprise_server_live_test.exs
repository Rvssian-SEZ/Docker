defmodule VdlarrWeb.Settings.AppriseServerLiveTest do
  use VdlarrWeb.ConnCase

  import Phoenix.LiveViewTest

  alias Vdlarr.Settings.AppriseServerLive
  ...
  describe "pressing the button" do
    ...
    test "sends a test message to the specified server", %{conn: conn} do
      expect(AppriseRunnerMock, :run, fn servers, args ->
        ...
        assert args == [title: "Vdlarr Test", body: "This is a test message from Vdlarr"]
