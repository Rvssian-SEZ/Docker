defmodule Pinchflat.Utils.CliUtils.LineCollector do
  @moduledoc false
...
defimpl Collectable, for: Pinchflat.Utils.CliUtils.LineCollector do
...
defmodule Pinchflat.Utils.CliUtils do
  ...
  alias Pinchflat.Utils.CliUtils.LineCollector
