defmodule Pinchflat.Boot.PreJobStartupTasks do
  ...
  # `check_and_update_timezone/0` (in Pinchflat.Application) validates the TZ/TIMEZONE
  ...
  defp apply_timezone_setting do
    case Settings.get!(:timezone) do
      nil -> Settings.set(timezone: Application.get_env(:pinchflat, :timezone))
      tz -> Application.put_env(:pinchflat, :timezone, tz)
    end
  end
