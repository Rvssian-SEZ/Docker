defmodule Vdlarr.HTTP.HTTPBehaviour do
  @moduledoc """
  ...
  @callback post(String.t(), String.t()) :: {:ok, String.t()} | {:error, String.t()}
  @callback post(String.t(), String.t(), Keyword.t()) :: {:ok, String.t()} | {:error, String.t()}
