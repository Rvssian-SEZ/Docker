defmodule Vdlarr.YtDlp.ReleaseLookup do
  @moduledoc """
  Looks up yt-dlp release information from the GitHub API.

  Used by `Vdlarr.YtDlp.UpdateManager` to discover the latest stable release (so
  the `nightly_until_stable` update policy knows when stable has caught up) and
  to validate that a user-supplied pinned version actually exists before saving it.
  """

  @repo_api "https://api.github.com/repos/yt-dlp/yt-dlp"
  @headers [{"User-Agent", "Vdlarr"}, {"Accept", "application/vnd.github+json"}]
