defmodule Vdlarr.Lifecycle.Notifications.CommandRunner do
  @moduledoc """
  ...
  alias Vdlarr.Lifecycle.Notifications.AppriseCommandRunner
  ...
  defp backend_executable do
    Application.get_env(:vdlarr, :apprise_executable)
  end
end
