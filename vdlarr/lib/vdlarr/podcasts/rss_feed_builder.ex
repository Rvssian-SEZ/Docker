defmodule Vdlarr.Podcasts.RssFeedBuilder do
  @moduledoc """
  ...
  alias VdlarrWeb.Router.Helpers, as: Routes
  ...
  def build(source, opts \\ []) do
    ...
    url_base = Keyword.get(opts, :url_base, VdlarrWeb.Endpoint.url())
  ...
  defp build_source_xml(source, media_items, url_base) do
    ...
    <rss version="2.0"
      ...
      <channel>
        ...
        <generator>Generated by Vdlarr</generator>
  ...
  defp podcast_route(action, params) do
    Routes.podcast_path(VdlarrWeb.Endpoint, action, params)
  end

  defp media_route(action, params) do
    Routes.media_item_path(VdlarrWeb.Endpoint, action, params)
  end
end
