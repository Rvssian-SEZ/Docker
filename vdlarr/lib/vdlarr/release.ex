defmodule Vdlarr.Release do
  ...
  def check_file_permissions do
    ...
    directories =
      [
        ...
        Application.get_env(:vdlarr, :extras_directory),
        Application.get_env(:vdlarr, :metadata_directory),
  ...
  defp permission_denied_screed(dir) do
    ...
    Or adding `user: '99:100'` to the Vdlarr service of your Docker Compose
    file. Again, there are many ways to do this depending on your setup and
    this is just one example. See issue #106 in the Vdlarr Github for more.
    ...
    to run the container as `root` because files created by Vdlarr may not
