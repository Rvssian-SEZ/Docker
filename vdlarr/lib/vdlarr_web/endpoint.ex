defmodule VdlarrWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :vdlarr
  ...
  plug Plug.Static,
    at: "/",
    from: :vdlarr,
    gzip: Application.compile_env(:vdlarr, :env) == :prod,
    only: VdlarrWeb.static_paths()
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :vdlarr
  end

  plug PromEx.Plug, prom_ex_module: Vdlarr.PromEx
