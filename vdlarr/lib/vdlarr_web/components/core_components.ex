defmodule VdlarrWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        ...
        @kind == :info && "border-[#1E3A8A] bg-[#1E3A8A]",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VdlarrWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VdlarrWeb.Gettext, "errors", msg, opts)
    end
  end
