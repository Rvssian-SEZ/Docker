defmodule VdlarrWeb.SessionController do
  ...
  def create(conn, %{"username" => username, "password" => password}) do
    configured_username = Application.get_env(:vdlarr, :login_username)
    configured_password = Application.get_env(:vdlarr, :login_password)
