defmodule Vdlarr.Settings.YtDlpVersionLive do
  @moduledoc """
  Update policy + pinned version fields for the Settings page, mirroring
  AppriseServerLive: values are name-fed into the outer settings form
  (`setting[...]`) and saved by the normal form submit, not a separate action.
  """

  use VdlarrWeb, :live_view

  alias VdlarrWeb.Settings.SettingHTML
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.input
        ...
        help="The exact yt-dlp version to install and hold, eg: 2025.12.08"
