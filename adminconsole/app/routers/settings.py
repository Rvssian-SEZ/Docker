...
_SECTION_KEYS = {
    ...
    "automation": ["semaphore.url", "semaphore.username", "semaphore.password", "semaphore.project_id", "semaphore.laps_template_id", "semaphore.unlock_template_id", "semaphore.delete_computer_template_id", "semaphore.move_object_template_id"],
