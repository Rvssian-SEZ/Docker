"""Landing page. Reporting views live in app/routers/reports.py. Until
Graph is configured, this degrades to a "not configured" state rather
than erroring, matching the spec's first-run requirement.
"""
