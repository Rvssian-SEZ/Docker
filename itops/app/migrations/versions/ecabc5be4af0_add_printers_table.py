...
def upgrade() -> None:
    ...
    op.create_index('ix_printers_asset_tag', 'printers', ['asset_tag'], unique=True)
    op.create_index('ix_printers_contract_id', 'printers', ['contract_id'])
    ...
    op.create_index('ix_printer_repairs_id', 'printer_repairs', ['id'])
...
def downgrade() -> None:
    ...
    op.drop_index('ix_printer_repairs_id', table_name='printer_repairs')
    op.drop_table('printer_repairs')
    op.drop_index('ix_printers_contract_id', table_name='printers')
    op.drop_index('ix_printers_asset_tag', table_name='printers')
